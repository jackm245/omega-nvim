    ...
    if target_node then
        ...
        if insert_pre_call then
            util.set_cursor_0ind(
                util.pos_add(target_node.mark:pos_begin_raw(), cursor_pos_pre_relative)
            )
        else
...
vim.keymap.set("i", "<c-e>", function()
    dynamic_node_external_update(3)
end, { noremap = true })
vim.keymap.set("i", "<c-r>", function()
    dynamic_node_external_update(4)
end, { noremap = true })
vim.keymap.set("i", "<c-t>", function()
    dynamic_node_external_update(5)
end, { noremap = true })
vim.keymap.set("s", "<c-q>", function()
    dynamic_node_external_update(1)
end, { noremap = true })
vim.keymap.set("s", "<c-w>", function()
    dynamic_node_external_update(2)
end, { noremap = true })
vim.keymap.set("s", "<c-e>", function()
    dynamic_node_external_update(3)
end, { noremap = true })
vim.keymap.set("s", "<c-r>", function()
    dynamic_node_external_update(4)
end, { noremap = true })
vim.keymap.set("s", "<c-t>", function()
    dynamic_node_external_update(5)
end, { noremap = true })
